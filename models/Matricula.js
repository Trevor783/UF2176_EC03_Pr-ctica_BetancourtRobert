...
const Matricula = {
    findAll: () =>
        pool.query(`
            SELECT
                ...
                a.nombre AS alumno,
                c.nombre AS curso,
                m.fecha_matricula::text AS fecha_matricula
            FROM matriculas m
    ...
    create: (alumno_id, curso_id, fecha_matricula) =>
        pool.query(
            `INSERT INTO matriculas (alumno_id, curso_id, fecha_matricula)
             VALUES ($1, $2, $3)
             RETURNING matricula_id, alumno_id, curso_id, fecha_matricula::text AS fecha_matricula`,
    ...
    update: (id, alumno_id, curso_id, fecha_matricula) =>
        pool.query(
            `UPDATE matriculas
             SET alumno_id = $1, curso_id = $2, fecha_matricula = $3
